...
void dynamicTopoFvMesh::moveCoupledSubMeshes()
{
    ...
    forAll(procIndices_, pI)
    {
        ...
        //  - Use empty lists for addressing to avoid over-writes
        ...
        // segfaults -- including the shipped circCylinder3d tutorial. Empty
        // lists give .empty() == true, so the transfers are skipped as the
